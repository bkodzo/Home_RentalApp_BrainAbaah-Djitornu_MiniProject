<!-- <div class="row"> -->			
  <div class="col-md-11 col-xs-12 col-sm-12"><br>  	
  	<div class="alert alert-info" role="alert">
		...
		?>
  		<h1 class="text-center">Apartment Registration</h1>
  		<form action="" method="POST">
		  	 <div class="row">
				...
				<div class="col-md-4">
				  <div class="form-group">
				    <label for="alternat_mobile">Alternative Contact</label>
			...
			<div class="row">
				 ...
				 <div class="col-md-4">
				  <div class="form-group">
				    <label for="plot_number">Plot Number/House Number</label>
			...
			<div class="row">
			 ...
			 <div class="row">
				...
				<div class="col-md-4">
				    <div class="form-group">
					    <label for="ownership">Owner/Rentee </label>
