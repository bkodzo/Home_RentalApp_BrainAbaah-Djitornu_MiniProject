...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Djitornu Homes</a>
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Djitornu Homes; Comfort and Ease!</div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Search through our cataloug</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
    ...
    <footer style="background-color: #ccc;">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <span class="copyright">Designed and Developed by: &copy; Brain Abaah-Djitornu|| KNUST || Computer Science</span>
          </div>
          <div class="col-md-4">
